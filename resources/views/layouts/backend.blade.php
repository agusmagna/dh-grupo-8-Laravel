...
<head>
    ...
    @yield('css')
    <link href="{{ asset('css/stylesLayoutBackend.css') }}" rel="stylesheet">
</head>
<body>
    <div id="app">
              ...
              <header>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto menu">
                      ...
                      <li><a href="{{ url('/panelAdmin') }}">Editar productos</a></li>
      ...
      <div class="footer-navegacion">
        ...
        <ul>
          <li><a href="{{ url('/index') }}">Inicio</a></li>
          <li><a href="{{ url('/admin/panelAdmin') }}">Editar productos</a></li>
        </ul>
        </ul>
        <div class="footer-capsulas">
          @for ($i=0; $i < 5; $i++)
