    ...
    public function run()
    {
      DB::table('machines')->insert(
        [
          ...
          'image'=>'public/machines/FFFFFF.png',
          'price'=>5000.00,
          'color'=>'white',
          'stock'=>500,
        ]);
        DB::table('machines')->insert(
          [
            ...
            'image'=>'public/machines/D7CDC5.png',
            'price'=>5000.00,
            'color'=>'#D7CDC5',
            'stock'=>500,
          ]);
        DB::table('machines')->insert(
          [
            ...
            'image'=>'public/machines/5F5B57.png',
            'price'=>5000.00,
            'color'=>'#5F5B57',
            'stock'=>500,
          ]);
        DB::table('machines')->insert(
          [
            ...
            'image'=>'public/machines/BCA99B.png',
            'price'=>5000.00,
            'color'=>'#BCA99B',
            'stock'=>500,
          ]);
        DB::table('machines')->insert(
          [
            ...
            'image'=>'public/machines/5C535F.png',
            'price'=>5000.00,
            'color'=>'#5C535F',
            'stock'=>500,
          ]);
        DB::table('machines')->insert(
          [
            ...
            'image'=>'public/machines/B9B5B0.png',
            'price'=>5000.00,
            'color'=>'#B9B5B0',
            'stock'=>500,
          ]);
        DB::table('machines')->insert(
          [
            ...
            'image'=>'public/machines/4B647F.png',
            'price'=>5000.00,
            'color'=>'#4B647F',
            'stock'=>500,
          ]);
